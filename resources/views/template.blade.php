    ...
    <div class="container">
      ...
      <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
        <div class="form-row">
          ...
          <div class="col-md-4 form-group">
            <input type="last_name" class="form-control" name="last_name" id="last_name" placeholder="Last Name" data-rule="last_name" data-msg="Please enter at least 4 chars">
            <div class="validate"></div>
          </div>
          <div class="col-md-4 form-group">
        ...
        <div class="form-row">
            <div class="col-md-4 form-group">
              <input type="phone_number" name="name" class="form-control" id="phone_number" placeholder="Phne Number" data-rule="minlen:10" data-msg="Please enter at least 10 chars">
              <div class="validate"></div>
            </div>
