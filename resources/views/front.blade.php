              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>
                        Everyone is screened and wears a mask before entering any of our care facilities.
                        ...
                        We've redesigned our patient areas to ensure physical distancing, which protects you, other patients and our staff.
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>
                        In accordance with guidance from the Ministry of Health in St. Lucia, Medic+ GH is performing select surgeries and procedures for our patients.
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>Students visiting their school nurse’s office in Central Castries can be assessed by doctors at Medic+ GH for free.
                      ...
                      Parents can participate in the appointments through a call and hear about their child’s diagnosis or prescription, or ask questions. </p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>Our in house pharmacy caters to all your medication needs.</p>
            </div>
          </div>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Schedule an appointment with one of our renowned specialists today!</p>
        </div>
                  ...
                  <div class="tab-pane active show" id="tab-1">
                      <div class="row">
                          <div class="col-lg-8 details order-2 order-lg-1">
                              ...
                              <p>
                                  Cardiologists specialize in the care and treatment of the heart. If you have been diagnosed or suspect a heart condition, our team of cardiologists are available to help!
                  ...
                  <div class="tab-pane" id="tab-2">
                      <div class="row">
                          <div class="col-lg-8 details order-2 order-lg-1">
                              ...
                              <p>
                                  Our world-class care is made possible by a renowned team of neurologists, neurosurgeons, nurses, physician assistants
                  ...
                  <div class="tab-pane" id="tab-3">
                      <div class="row">
                          <div class="col-lg-8 details order-2 order-lg-1">
                              ...
                              <p>
                                  The country's leading family physicians are available 24-7 to provide the best healthcare in internal medicine.
                                  The prevalence of patients with gallstone has been recently increasing and it is getting economic burden worldwide.
                                  We investigate the mechanism of cholesterol gallstone formation focusing on the biliary lipid metabolism.
                              </p>
                          </div>
                          <div class="col-lg-4 text-center order-1 order-lg-2">
                  ...
                  <div class="tab-pane" id="tab-4">
                      <div class="row">
                          <div class="col-lg-8 details order-2 order-lg-1">
                              ...
                              <p class="font-italic">
                                  Medic+ GH specializes in infant and adolescent care using advanced medicinal techniques
                              </p>
                              <p>
                                  We treat over 10,000 infants yearly, for a plethora of rare diseases.
                                  ...
                                  neonatology, metabolic disease, neurology, endocrinology, allergology, rheumatology, cardiology, nephrology, and psychology
                              </p>
                          </div>
                          <div class="col-lg-4 text-center order-1 order-lg-2">
                  ...
                  <div class="tab-pane" id="tab-5">
                      <div class="row">
                          <div class="col-lg-8 details order-2 order-lg-1">
                              ...
                              <p>
                                  Our oncologists are specially trained to deal with over 50 types of rare cancers and treatment methods. The department has been recognized by the
                                  ...
                                  which permits millimeters order precision for lung and liver cancers.
                              </p>
                          </div>
                          <div class="col-lg-4 text-center order-1 order-lg-2">
